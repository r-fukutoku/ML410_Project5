...
2. Simulate 100 data sets, each with 1200 features, 200 observations and a toeplitz correlation structure such that the correlation between features ii and jj is approximately \rho^{|i-j|}ρ ∣i−j∣
